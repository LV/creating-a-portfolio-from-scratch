...
This document strives to be a starting point towards understanding how to build a portfolio. It's a way for me to learn as I write this, and for a resource others can use (shoutout Cristian and Diego).

## Methodology

There is a particular order we should follow in our portfolio construction process:
...
- Max drawdown of $\textcolor{red}{-35\%}$
    - Means how much of a fall am I genuinely able to stomach before I begin panic selling
- I only have access to the following asset classes:
    - via Charles Schwab
        - Equities
