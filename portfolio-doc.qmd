...
```{ojs}
{
  ...
  function renderSVG(age) {
    ...
    const descHeight = 48;
    const height = Math.max(radius * 2 + 40, legendHeight + 40) + descHeight;
  ...
  const wrapper = html`<div style="background:#fff;border:1px solid #ddd;border-radius:4px;padding:20px 24px 14px;margin:16px 0;">
